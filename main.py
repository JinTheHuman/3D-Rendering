...
objects = [Cube([0,0,0], 150, [0,150,200]), Cube([0,0,0], 150, [0,450,200]), Cube([0,0,0], 150, [400,150,200]), 
           Cube([0,0,0], 150, [0,150,550]), Cube([0,0,0], 150, [0,450,550]), Cube([0,0,0], 150, [400,150,550]), Cube([0,0,0], 150, [0,750,200]), Cube([0,0,0], 150, [0,1050,200]),Cube([0,0,0], 150, [0,1350,200]),Cube([0,0,0], 150, [0,1650,200]),]

# objects = [Cube([0,0,0], 150, [0,150,600]), Cube([0,0,0], 150, [600,150,0])]
...
if __name__ == '__main__':
  ...
  while running:  
    ...
    # PROCESS WORLD
    for cube in objects:
      rotation = rotation_matrix(cube.rotation[0], cube.rotation[1], cube.rotation[2])
      translation = cube.translation
      scale = cube.scale
      
      for face in faces:
        world_plane = [transform_point(vertices[vertex - 1], rotation, scale, translation) for vertex in face]
        
        relative_plane = [map_to_viewer(point, viewer_pos) for point in world_plane]
        relative_plane = [rotate_point(point, rotation_matrix(ypivot_rotation,xpivot_rotation,0)) for point in relative_plane]
      ...
      for vertex in vertices:
        ...
        relative_point = rotate_point(relative_point, rotation_matrix(ypivot_rotation, xpivot_rotation, 0))
